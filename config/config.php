...
define("COOKIE_DOMAIN", "fusioninfinite.com");
define("COOKIE_SECRET_KEY", "1gp@T2adsadfafnwaioc82-92s");
...
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "karl@fusioninfinite.com");
define("EMAIL_SMTP_PASSWORD", "fus10n3m@1l");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://fusioninfinite.com/ReadingLog/php-login-advanced/password_reset.php");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://fusioninfinite.com/ReadingLog/php-login-advanced/register.php");
define("EMAIL_VERIFICATION_FROM", "karl@fusioninfinite.com");
define("EMAIL_VERIFICATION_FROM_NAME", "ReadingLog");
